						...
						if (lObj.text) {
							...
							this[name] = (...args) => {
								...
								if (this.loggers[name].format.callerLine) {
									...
									var logArgs = [chalk.hex(logOpts.color).bold(this.loggers[name].format.startChar + this.loggers[name].text + this.loggers[name].format.fname + this.loggers[name].format.lineNumSeparator + cleanCaller + this.loggers[name].format.endChar), ...args]
								} else {
									var logArgs = [chalk.hex(this.loggers[name].color).bold(this.loggers[name].startChar + this.loggers[name].text + this.loggers[name].fname + this.loggers[name].endChar), ...args]
								}
